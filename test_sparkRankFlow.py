...
def async_data(environment):
    try:
        ...
        if total_count > 0 and environment == "beta":
...
if __name__ == '__main__':
    ...
    zeus_poi_path = '/user/go2data/base_data/pub_data/milestone/20170906/nochange/POI'
    zeus_myself_path = '/user/go2data/base_data/pub_data/milestone/20170906/temp/extends/surrounding/result'
    zeus_structure_path = '/user/go2data/base_data/pub_data/milestone/20170906/temp/extends/struct/structure/name_prefix_structure_release'
    zeus_polygon_path = '/user/go2data/base_data/pub_data/milestone/20170906/nochange/POLYGON'
